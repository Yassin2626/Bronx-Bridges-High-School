      ...
      <div className="min-h-screen bg-white mt-20">
        ...
        <div className="bg-gray-100 py-24 animate-fade-in">
          <div className="container mx-auto px-6 text-center">
            <h1 className="text-7xl md:text-9xl font-bold mb-6 text-black animate-slide-up">Who We Are</h1>
            ...
            <div className="prose prose-lg text-gray-800">
              ...
              <div className="text-center mb-8 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <img
                  ...
                  className="w-[90%] mx-auto rounded-lg shadow-lg animate-slide-up"
                />
              </div>

              <p className="text-xl leading-relaxed mb-8 animate-slide-up" style={{ animationDelay: '0.6s' }}>
              ...
              <p className="text-xl leading-relaxed mb-8 animate-slide-up" style={{ animationDelay: '0.8s' }}>
              ...
              <p className="text-xl leading-relaxed mb-8 animate-slide-up" style={{ animationDelay: '1s' }}>
              ...
              <div className="bg-gray-50 border-l-4 border-gray-500 p-6 my-8 animate-slide-up" style={{ animationDelay: '1.2s' }}>
              ...
              {/* Values Section */}
              <h2 className="text-3xl font-bold text-gray-800 mb-6 animate-slide-up" style={{ animationDelay: '1.4s' }}>Our Values</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 p-6 rounded-lg animate-fade-in" style={{ animationDelay: '1.6s' }}>
                ...
                <div className="bg-gray-50 p-6 rounded-lg animate-fade-in" style={{ animationDelay: '1.8s' }}>
                ...
                <div className="bg-gray-50 p-6 rounded-lg animate-fade-in" style={{ animationDelay: '2s' }}>
                ...
                <div className="bg-gray-50 p-6 rounded-lg animate-fade-in" style={{ animationDelay: '2.2s' }}>
